...
namespace CleanArchitecture.Application.Features.Streamers.Commands.UpdateStreamer
{
	internal class UpdateStreamerCommandHandler : IRequestHandler<UpdateStreamerCommand>
	{
		...
		public UpdateStreamerCommandHandler(IStreamerRepository streamerRepository, IMapper mapper, ILogger<UpdateStreamerCommandHandler> logger, IUnitOfWork unitOfWork)
		{
